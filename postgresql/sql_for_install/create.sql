...
CREATE SEQUENCE public."Role_ID_serial" AS INTEGER;
CREATE TABLE public."Role" (
    "ID" INTEGER DEFAULT nextval('public."Role_ID_serial"'),
...
CREATE SEQUENCE public."Template_ID_serial" AS INTEGER;
CREATE TABLE public."Template" (
    "ID" INTEGER DEFAULT nextval('public."Template_ID_serial"'),
...
CREATE TABLE public."Answer" (
    ...
    "ShareCode" CHARACTER VARYING(10),
    "Archive" BOOLEAN DEFAULT FALSE,
    "CreateAt" TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    "UpdateAt" TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE public."SheetPredict" (
    ...
    "PredictAt" TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE public."AnswerEditLog" (
    ...
    "EditAt" TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
